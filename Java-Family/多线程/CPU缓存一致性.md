...
![图片](https://520li.oss-cn-hangzhou.aliyuncs.com/img/book/20201220215537.png)
...
![图片](https://520li.oss-cn-hangzhou.aliyuncs.com/img/book/20201220215657.png)
...
![图片](https://520li.oss-cn-hangzhou.aliyuncs.com/img/book/20201220215710.png)

我们当然期望 CPU 读取数据的时候，都是尽可能地从 CPU Cache 中读取，而不是每一次都要从内存中获取数据。所以，身为程序员，我们要尽可能写出缓存命中率高的代码，这样就有效提高程序的性能，具体的做法，可以参考文章[「如何写出让 CPU 跑得更快的代码？」](https://mp.weixin.qq.com/s?__biz=MzUxODAzNDg4NQ==&mid=2247486022&idx=1&sn=8bb5a066d81f77523a06cd09251055da&scene=21#wechat_redirect)
...
![图片](https://520li.oss-cn-hangzhou.aliyuncs.com/img/book/20201220220055.png)
...
![图片](https://520li.oss-cn-hangzhou.aliyuncs.com/img/book/20201220220137.png)
...
![图片](https://520li.oss-cn-hangzhou.aliyuncs.com/img/book/20201220220312.png)
...
![图片](https://520li.oss-cn-hangzhou.aliyuncs.com/img/book/20201220220332.png)
...
![图片](https://520li.oss-cn-hangzhou.aliyuncs.com/img/book/20201220220409.png)
...
![图片](https://520li.oss-cn-hangzhou.aliyuncs.com/img/book/20201220220753.png)

MESI 协议的四种状态之间的流转过程，我汇总成了下面的表格，你可以更详细的看到每个状态转换的原因：

![图片](https://520li.oss-cn-hangzhou.aliyuncs.com/img/book/20201220220807.png)
